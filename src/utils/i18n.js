...
export const UI_TEXT = {
  en: {
    ...
    inbox: {
      ...
      noShared: 'No shared tasks yet',
      noSharedHint: 'Tasks shared with you by other users will appear here',
      scheduled: 'Scheduled',
    ...
    settings: {
      ...
      googleConnectFailed: 'Could not connect Google. Check Supabase manual identity linking and Google provider settings.',
      signOut: 'Sign out',
  ...
  ru: {
    ...
    inbox: {
      ...
      noShared: 'Задач от других пока нет',
      noSharedHint: 'Здесь будут задачи, которые вам прислали другие пользователи',
    ...
    settings: {
      ...
      googleConnectFailed: 'Не удалось подключить Google. Проверь manual identity linking и Google provider в Supabase.',
      signOut: 'Выйти',
